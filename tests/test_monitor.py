...
class TestLoadMonitor:
    ...
    @patch('builtins.open', new_callable=mock_open, read_data="1.23 4.56 7.89 12/34 56789")
    ...
    @patch('builtins.open', new_callable=mock_open, read_data="1.23 4.56 7.89 invalid/34 56789")
    ...
    @patch('builtins.open', new_callable=mock_open, read_data="cpu  123 456 789\ncpu0 123 456 789\ncpu1 123 456 789")
